    ...
    public class AsyncApiComponents : IAsyncApiExtensible, IAsyncApiSerializable
    {
        ...
        public void SerializeV3(IAsyncApiWriter writer)
        {
            ...
            writer.WriteOptionalMap(
                ...
                {
                    if (component.Reference != null &&
                        component.Reference.Type == ReferenceType.Operation &&
                        component.Reference.Id == key)
                    {
                        component.SerializeV2WithoutReference(w);
                    }
            ...
            // replies
            writer.WriteOptionalMap(
                AsyncApiConstants.Replies,
                this.Replies,
                (w, key, component) =>
                {
                    if (component.Reference != null &&
                        component.Reference.Type == ReferenceType.Reply &&
                        component.Reference.Id == key)
                    {
                        component.SerializeV2WithoutReference(w);
                    }
            ...
            // replyaddresses
            writer.WriteOptionalMap(
                AsyncApiConstants.ReplyAddresses,
                this.ReplyAddresses,
                (w, key, component) =>
                {
                    if (component.Reference != null &&
                        component.Reference.Type == ReferenceType.ReplyAddress &&
                        component.Reference.Id == key)
                    {
                        component.SerializeV2WithoutReference(w);
                    }
            ...
            writer.WriteOptionalMap(
                ...
                {
                    if (component.Reference != null &&
                        component.Reference.Type == ReferenceType.ExternalDocs &&
                        component.Reference.Id == key)
                    {
                        component.SerializeV2WithoutReference(w);
                    }

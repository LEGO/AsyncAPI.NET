    ...
    public class JsonSchemaDeserializer
    {
        private static readonly FixedFieldMap<AsyncApiSchema> schemaFixedFields = new()
        {
            ...
            },
            {
                ...
                (a, n) =>
                {
                    a.MultipleOf = double.Parse(n.GetScalarValue(), NumberStyles.Float, n.Context.CultureInfo);
                }
            },
            {
                "maximum",
                (a, n) =>
                {
                    a.Maximum = double.Parse(n.GetScalarValue(), NumberStyles.Float, n.Context.CultureInfo);
                }
            },
            {
            ...
            },
            {
                ...
                (a, n) =>
                {
                    a.Minimum = double.Parse(n.GetScalarValue(), NumberStyles.Float, n.Context.CultureInfo);
                }
            },
            {
            ...
            {
                "maxLength", (a, n) => { a.MaxLength = int.Parse(n.GetScalarValue(), n.Context.CultureInfo); }
            },
            {
                "minLength", (a, n) => { a.MinLength = int.Parse(n.GetScalarValue(), n.Context.CultureInfo); }
            },
            {
                "pattern", (a, n) => { a.Pattern = n.GetScalarValue(); }
            },
            {
                "maxItems", (a, n) => { a.MaxItems = int.Parse(n.GetScalarValue(), n.Context.CultureInfo); }
            },
            {
                "minItems", (a, n) => { a.MinItems = int.Parse(n.GetScalarValue(), n.Context.CultureInfo); }
            },
            {
            ...
            {
                "maxProperties",
                (a, n) => { a.MaxProperties = int.Parse(n.GetScalarValue(), n.Context.CultureInfo); }
            },
            {
                "minProperties",
                (a, n) => { a.MinProperties = int.Parse(n.GetScalarValue(), n.Context.CultureInfo); }
            },
            {

...
";
            ...
            Assert.AreEqual((doc.Channels["workspace"].Extensions["x-eventarchetype"] as AsyncApiString).Value,
                "objectchanged");
            Assert.AreEqual((doc.Channels["workspace"].Extensions["x-classification"] as AsyncApiString).Value,
                "green");
...
";
            ...
            Assert.AreEqual("Provide your username and password for SASL/SCRAM authentication",
